...
const ProductForm = () => {
  ...
  const handleFileChange = async (e) => {
    ...
    const availableSlots = Math.max(0, MAX_PRODUCT_IMAGES - (images.length + newFiles.length + totalColorFiles));
...
//   try {
//     const validFile = await validateImage(file, 'product');
//     // Success! Update state or upload to server
//     setMyImage(validFile); 
//   } catch (errorMessage) {
//     // Fail! Show a toast error to the user
