...
//       {/* Back Button - Only renders if an onBack function is provided */}
//       {onBack ? (
//         <Button
//           variant="outlined"
//           disabled={isLoading}
...
//         </Button>
//       ) : (
//         <Box /> // Empty box keeps the flex "space-between" layout aligned if there is no back button
//       )}
...
//           '&.Mui-disabled': { backgroundColor: '#9ca3af', color: '#f3f4f6' }
//         }}
//       >
//         {isLoading ? (
//           <CircularProgress size={24} color="inherit" />
